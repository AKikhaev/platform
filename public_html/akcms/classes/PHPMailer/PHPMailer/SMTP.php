...
class SMTP
{
    ...
    public function startTLS()
    {
        ...
        stream_context_set_option($this->smtp_conn, 'ssl', 'cafile', '/etc/ssl/certs/cacert.pem'); ###
    ...
    {
        $noerror = true; ### Пошли все нахер никакого прощания с бесконечным ожиданием ответа
