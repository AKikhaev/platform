...
/** https://github.com/sunra/php-simple-html-dom-parser * https://github.com/voku/simple_html_dom new should to try
...
class simple_html_dom_node
{
    ...
    function find($selector, $idx=null, $lowercase=false)
    {
        ...
        foreach ($found_keys as $k=>$v)
            if(!$this->dom->nodes[$k]->getAttribute('softDelete')) ////!!! не забыть
