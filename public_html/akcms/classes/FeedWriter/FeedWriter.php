...
require_once(dirname(__FILE__) . '/FeedItem.php');
 ...
 * @link        http://www.ajaxray.com/projects/rss https://github.com/ajaxray/FeedWriter
 */
abstract class FeedWriter
{
	...
	*/
	private function makeNode($tagName, $tagContent, $attributes = null)
	{
		...
		{
			$nodeText .= (in_array($tagName, $this->CDATAEncoding))? $this->sanitizeCDATA($tagContent) : htmlspecialchars($tagContent,ENT_QUOTES,'UTF-8');
		}
