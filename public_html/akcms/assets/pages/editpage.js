        ...
        if (treeviewDiv!==null)
            $treeview = treeviewDiv.treeview({
                ...
                onRendered:function(e){
                    ...
                    $('.sec_new' ).click(function(e){ e.preventDefault(); e.stopPropagation(); _this.makeEditPage(_this.getNodeId($(this)),0,$(this).closest('li')); });
                    $('.sec_edit').click(function(e){ e.preventDefault(); e.stopPropagation(); _this.makeEditPage(0,_this.getNodeId($(this)),$(this).closest('li')); });
                    treeLoaded = true;
